...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (yearElement) {
        ...
        yearElement.textContent = `© ${currentYear} Care Point Hospital. All rights reserved.`;
    }
    ...
    // ============================
    console.log('%c👋 Welcome to Care Point Hospital!', 'color: #3b82f6; font-size: 20px; font-weight: bold;');
